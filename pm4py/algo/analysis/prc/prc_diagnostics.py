...
def prc_bottleneckdetection_sr(log: Union[EventLog, pd.DataFrame], net: PetriNet, initial_marking: Marking, final_marking: Marking, parameters: Optional[Dict[str, Any]] = None) -> pd.DataFrame:
    ...
    tbr_results, place_fitness, transition_fitness, notexisting_activities, \
    place_token_timeline, place_time_diffs, place_alerts, place_storage_levels, \
    place_frequency_counts = tbr_prc.apply_log(
        log=log,
        net=net,
